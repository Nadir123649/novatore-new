    ...
    return (
        <Layout title="Novatore Sols - Digital Business" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Business Applications for Modern Enterprises" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/bussinees-banner.png" maxwidth="900px" />
