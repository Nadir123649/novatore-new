...
const DigitalBusiness: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - Digital Business" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
