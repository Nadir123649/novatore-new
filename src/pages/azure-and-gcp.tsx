    ...
    return (
        <Layout title="Novatore Sols - Azure & GCP" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Azure & GCP: Powering the Future of Cloud Computing" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/azure-banner-bg.png" maxwidth="900px" />
