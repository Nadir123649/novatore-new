...
const FootEducation: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Solutions - Foot Education" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
