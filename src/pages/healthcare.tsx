...
const Healthcare: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Leading Web and Mobile Apps in Healthcare | Novatore Solutions" description="We are committed to providing exceptional services that empower healthcare providers to deliver quality care in the fast-evolving health landscape. Learn more." keywords={"Healthcare Technology Solutions, Telemedicine Platforms, Patient Management Systems, Health Information Systems, EHR Development (Electronic Health Records), EMR Development (Electronic Medical Records), Remote Patient Monitoring, Patient Engagement Tools, Healthcare Mobile Apps, Clinical Decision Support Systems"}>
