...
const Healthcare: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - Healthcare" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
