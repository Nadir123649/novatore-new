...
const UiUxDesign: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - UI/UX Design" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
