...
const JuggernautDeFi: NextPage = () => {
    return (
        <Layout showContactForm={false} title="Novatore Solutions - Juggernaut DeFi" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
