    ...
    return (
        <Layout title="Novatore Sols - Custom Software Development" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                ...
                <ServicesNeeds needsTitle="Innovative Software Development for " needsTitleBlue="  Modern Businesses" NeedsImage="/images/custom-development-image.png"
                ...
                <ExpertServices needsTitle="Our " needsTitleBlue="Expertise" needsMoreTitle=" in Web and Mobile Application Development" NeedsImage="/images/expertise-applications-image.png"
