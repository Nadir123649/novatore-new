    ...
    return (
        <Layout title="Novatore Sols - Custom Software Development" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                ...
                <ServicesNeeds needsTitle="Innovative  " needsTitleBlue="Software Development" needsMoreTitle="for Modern Businesses" NeedsImage="/images/custom-software-development.png"
                ...
                <ExpertServices needsTitle="Our Expertise in  " needsTitleBlue="Web" spantitle="&" needsMoreTitleblue="Mobile" needsMoreTitle=" Application Development" NeedsImage="/images/expertise-applications.png"
