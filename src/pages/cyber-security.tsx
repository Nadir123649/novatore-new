...
const CyberSecurity: NextPage = () => {
    ...
    return (
        <Layout showContactForm={true} title="Novatore Solutions - Cyber Security" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
