    ...
    return (
        <Layout title="Novatore Sols - Analytics Services " description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Unlocking the Power of Analytics for Smarter Decisions" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/analytics-services-banner-bg.png " maxwidth="900px" />
