...
const DigitalService: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore's Digital Services For Your Online Presence" description="Novatore Solutions offers end-to-end digital services, from cloud solutions to app development, helping businesses achieve their goals. Learn more today!">
