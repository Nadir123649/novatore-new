...
const Upsure: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Solutions - Upsure" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
