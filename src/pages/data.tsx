    ...
    return (
        <Layout title="Novatore Sols - Data" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Our Innovative Approach Towards Data Engineering " pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/data-engenering.png" />
