    ...
    return (
        <Layout title="Novatore Sols - Storage Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Storage Services for Uninterrupted Business Growth" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/storage-banner.png" />
