    ...
    return (
        <Layout title="Novatore Sols - Amazon Web Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                ...
                <ServicesNeeds needsTitle="Transforming Businesses with" needsTitleBlue="Amazon Web Services" NeedsImage="/images/amazon-right.png"
               ...
               edge in today’s fast-paced market." />
                ...
                <ExpertServices needsTitle="AWS Services: Changing Your Digital" needsTitleBlue="Landscape" NeedsImage="/images/amazon-left.png"
