...
const BusinessProcessAutomation: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Solutions - Business Process Automation" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
