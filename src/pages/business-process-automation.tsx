    ...
    return (
        <Layout title="Novatore Sols - Business Process Automation" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Cost-Effective Business Process Automation" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/process-automation.png" maxwidth="1100px" />
