...
const CloudOpsPage: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - CloudOps" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
