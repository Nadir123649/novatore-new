...
const CloudOpsPage: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Achieve Operational Excellence with Professional CloudOps" description="Novatore Solutions offers a suite of CloudOps services designed to align with your business. Our CloudOps consulting provides guidance on best practices, learn more!" keywords="What is CloudOps, CloudOps best practices, Benefits of CloudOps, CloudOps vs DevOps, CloudOps tools and technologies, CloudOps services, CloudOps consulting, CloudOps implementation, CloudOps solutions, CloudOps managed services">
