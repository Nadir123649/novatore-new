    ...
    return (
        <Layout title="Novatore Sols - CloudOps" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Achieve Operational Excellence with Professional CloudOps" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/cloud-ops-banner.png" />
