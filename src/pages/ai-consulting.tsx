    ...
    return (
        <Layout title="Novatore Sols -  Ai Consulting" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Transform Your Business with AI Consulting Services" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/consulting-banner-bg.png" maxwidth="800px" />
