    ...
    return (
        <Layout title="Novatore Sols - Digital Transformation" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Empowering Your Journey With Our Digital Transformation" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/digital-transformation-banner.png" maxwidth="1000px" />
