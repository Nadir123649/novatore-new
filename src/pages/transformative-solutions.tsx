    ...
    return (
        <Layout title="Novatore Sols - Transformative Solutions" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="The Transformative Solutions Your Business Needs" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/transformation-image-banner.png" maxwidth="1100px" />
