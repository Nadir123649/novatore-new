    ...
    return (
        <Layout title="Novatore Sols - Data Management & Governance" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Your Partner in Data Management & Governance" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/data-managment-banner.png" />
