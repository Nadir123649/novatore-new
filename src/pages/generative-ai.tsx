    ...
    return (
        <Layout title="Novatore Sols - Generative AI" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Generative AI: Revolutionizing Art, Design, and Content Creation" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/generative-banner-bg.png" />
