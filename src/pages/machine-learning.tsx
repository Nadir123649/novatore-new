    ...
    return (
        <Layout title="Novatore Sols - Machine Learning " description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Unleash Your Potential With Our Machine Learning Tools" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/machine-learning-banner.png" maxwidth="1100px" />
