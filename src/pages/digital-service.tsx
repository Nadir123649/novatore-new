    ...
    return (
        <Layout title="Novatore Sols - Digital Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Our Digital Services to Enhance Your Online Presence" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/digital-service.png" maxwidth="1000px" />
