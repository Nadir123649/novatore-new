...
const DigitalService: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - Digital Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
