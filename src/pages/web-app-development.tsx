...
const WebApp: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - Web Application Development" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
