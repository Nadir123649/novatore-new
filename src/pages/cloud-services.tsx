    ...
    return (
        <Layout title="Novatore Sols - Cloud Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Efficient Cloud Services to Uplift Your Infrastructure" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/cloud-banner.png" maxwidth="1000px" />
