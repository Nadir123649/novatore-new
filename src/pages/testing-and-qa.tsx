    ...
    return (
        <Layout title="Novatore Sols - Testing and QA" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Reliable QA Services to Elevate Your Software Quality" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/testing-banner.png" />
