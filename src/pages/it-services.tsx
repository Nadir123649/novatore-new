    ...
    return (
        <Layout title="Novatore Sols - IT Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="An Insight into Novatore's IT Services" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/It-banner.png" maxwidth="780px" />
