...
const ItServices: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Solutions - IT Services" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
