...
const GovernanceAndDataPrivacy: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Solutions - Governance, Risk & Compliance, and Data Privacy" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
