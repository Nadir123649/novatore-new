    ...
    return (
        <Layout title="Novatore Sols - Analytics & Platform Implementation" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Analytics & Platform Implementation" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/analytics-banner-bg.png" maxwidth="900px" />
