...
const JobOpenings: NextPage = () => {
    ...
    return (
        ...
        <Layout showContactForm={true} title="Novatore Solutions - Job Openings" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
            ...
            <DataServicesSection heading="Your Dream Job Awaits at Novatore" data={jobOpeningData} textalign='center' viewallbutton={true} />
            <Enterprise />
            <Innovation />
        </Layout>
    );
