    ...
    return (
        <Layout title="Novatore Sols - Enterprise Mobility" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                ...
                <ServicesNeeds needsTitle="Transform Your Business with Our " needsTitleBlue=" Enterprise Mobility" needsMoreTitle="Solutions" NeedsImage="/images/mobility-right.png"
                ...
                <ExpertServices needsTitle="Your Business Needs the  " needsTitleBlue=" Best Enterprise" needsMoreTitle=" Mobility Management (EMM)" NeedsImage="/images/mobility-left.png"
