...
const EnterpriseMobility: NextPage = () => {
    return (
        <Layout showContactForm={true} title="Novatore Sols - Enterprise Mobility" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
