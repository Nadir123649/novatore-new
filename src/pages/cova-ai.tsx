...
const CovaAI: NextPage = () => {
    return (
        <Layout showContactForm={false} title="Novatore Solutions - Cova AI" description="Welcome to Novatore Solutions, setting new standards in technology with unmatchable code.">
