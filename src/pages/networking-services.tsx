    ...
    return (
        <Layout title="Novatore Sols - Networking Services" description="Welcome to Novatore Sols, setting new standards in technology with unmatchable code.">
            <div className="overflow-x-hidden">
                <HeroBanner bannerHeading="Networking Redefined: Connecting Your Business to Success" pagetitle="Services" needsMoreTitle="Get in Touch" previewImage="/images/networking-banner.png" />
