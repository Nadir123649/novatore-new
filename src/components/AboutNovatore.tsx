        ...
        <section className=' bg-white py-20'>
            <Container>
                <div className="brandind-content text-center">
                    ...
                    <p className=' text-black not-italic text-[20px] font-normal mb-[80px] max-w-[947px] mx-auto leading-[30px]'>
                ...
                <Row>
                    <Col lg={6} md={6} xs={12} className='flex justify-center items-center flex-col'>
                        <div className="about-content">
                            <h2 className='text-black text-[40px] not-italic font-semibold capitalize leading-normal'>How did it all start?</h2>
                            <p className='text-black text-[20px] not-italic font-normal leading-[30px] max-w-[509px]'>
