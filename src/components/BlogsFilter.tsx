    ...
    return (
        <div className="blogs-filter-container blogs-filter-container flex justify-between items-center">
            ...
            <div className="filter-controls filter-controls flex items-center gap-[16px]">
                <div className="input-with-icon flex flex-row gap-2 py-[12px] px-[16px] form-input-input  border-[#969696] border border-solid rounded-[36px] max-w-[260px] min-w-[260px] ">
                ...
                <button className="bg-[#2776EA] rounded-[36px] py-[12px] px-[16px]  max-w-[116px] min-w-[116px]  text-white text-[18px] font-normal">Search</button>
            </div>
        </div>
    );
};
