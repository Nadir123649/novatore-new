...
const DataCard: React.FC<DataCardProps> = ({ title, description, icon, type, listItems, value, className, minHeight }) => {
    return (
        <div className={type ? type : "relative bg-white shadow rounded-[16px] pt-[40px] pb-[10px] px-[24px] max-w-sm mx-auto overflow-hidden flex flex-col h-full hover:scale-105 transition ease-in duration-1.5"}
