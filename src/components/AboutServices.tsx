    ...
    return (
        <section className='bg-black py-20'>
            <Container>
                ...
                <p className='text-white text-[32px]  not-italic font-normal leading-normal max-w-[728px] mb-[80px]'>Novatore Solutions offers a wide array of services designed to meet various technological needs:</p>
                    ...
                    {aboutServicesData.map((data, index) => (
                        <Col key={index} lg={4} md={6} xs={12}>
                            <div className="about-services-data  text-white min-h-[186px] bg-[#0C0C0C] border-[0.5px] border-solid rounded-[20px]  pl-[34px]  pt-[28px] flex flex-col gap-2">
                                ...
                                <p className=' text-white text-[16px] leading-5 not-italic font-normal pr-10'>{data.description}</p>
                            </div>
                        </Col>
                    ))}
                </Row>
