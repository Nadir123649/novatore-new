...
const NextArrow: React.FC<ArrowProps> = ({ onClick }) => {
  return (
    <div onClick={onClick} className="arrow next">
      <span className="text-[#969696] text-lg">
        <FaChevronRight />
      </span>
    </div>
  );
...
const Services = () => {
  ...
  return (
    <section className="services-section py-20 bg-center bg-no-repeat bg-cover ">
        ...
        <Slider {...settings} className="services-slider">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="text-[30px] absolute bottom-[20px] right-[20px] arrow-upright">
                <GoArrowUpRight />
              </div>
            </div>
          ))}
