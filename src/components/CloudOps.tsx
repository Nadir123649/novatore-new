              ...
              <Col lg={12} md={12} xs={12}>
                <div className="grid grid-cols-12 gap-4 py-[20px] min-h-[100vh]">
                  ...
                  <div className="col-span-12 md:col-span-4">
                    <div className="cloudops-card text-white bg-[#2776EA] rounded-2xl p-4 min-h-[45vh] md:min-h-[80vh] max-w-[360px] sticky top-0">
                      <TransitionGroup>
                        {detailsForCurrentRoute.map((data, index) => (
                          <CSSTransition
                            ...
                            classNames="fade"
                          >
                            <p className="text-xl md:text-2xl">{data.details}</p>
                          </CSSTransition>
                        ))}
                      </TransitionGroup>
